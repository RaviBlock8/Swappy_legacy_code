...
export default function PoolPage({
	...
	errorMsg,
	handleSubmit,
	changeAmountOftokenInType,
	changeAmountOftokenOutType,
}: any) {
	return (
		<SwapPageBox>
				...
				<MainInputBox>
					<InputBox1>
						...
						<InputField
							...
							onChange={changeAmountOftokenInType}
						/>
						<SelectC
							value={tokenInType}
					...
					<InputBox1>
						...
						<InputField
							...
							onChange={changeAmountOftokenOutType}
						/>
						<SelectC
							value={tokenOutType}
							disableUnderline={true}
          ...
          <ExchangeChart />
				...
				<Footer type="submit" style={{outline:"none"}}>Add Liquidity</Footer>
			</form>
		</SwapPageBox>
	);
}
